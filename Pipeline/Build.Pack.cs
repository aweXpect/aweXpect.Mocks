...
partial class Build
{
	Target UpdateReadme => _ => _
		...
		.Executes(() =>
		{
			...
			sb.AppendLine(
				$"[![Changelog](https://img.shields.io/badge/Changelog-v{version}-blue)](https://github.com/aweXpect/aweXpect.Mocks/releases/tag/v{version})");
			foreach (string line in lines.Skip(1))
			{
				if (line.StartsWith("[![Build](https://github.com/aweXpect/aweXpect.Mocks/actions/workflows/build.yml") ||
